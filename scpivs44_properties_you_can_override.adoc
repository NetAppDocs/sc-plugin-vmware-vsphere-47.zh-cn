...
* *禁用.弱 密码=true*
+
为适用于VMware vSphere的SnapCenter 插件和SnapCenter 之间的通信通道禁用以下弱密码、以及中列出的任何其他弱密码 `include.weakCiphers`：tls_rsa_by_aes_256_cbc_SHA256 tls_DHE_RSA_BG_Aes_256_CBC_SHA256 tls_RSA_the_128_CBC_SHA256 TLS_RSA_SHAA_SHA256 TLS_ECGCM DHE_128_CH_AES_256_RSA_tls__RSA_CH_256_TLS_RSA_SHAA_SHAA_SHA256
